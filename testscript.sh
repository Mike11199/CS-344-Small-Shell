...
printf	Testing: $(tput bold)head -c 1000 /dev/zero > 1k-null-bytes$(tput sgr0)\n
head	-c	1000	/dev/zero	>	1k-null-bytes
printf	Testing: $(tput bold)wc -c 1k-null-bytes$(tput sgr0) (Expecting "1000 1k-null-bytes", $(tput setaf 4 bold)15 points$(tput sgr0))\n
wc	-c	1k-null-bytes
printf	Testing: $(tput bold)wc -c < 1k-null-bytes$(tput sgr0) (Expecting "1000", $(tput setaf 4 bold)10 points$(tput sgr0))\n
wc	-c	<	1k-null-bytes
printf	Testing: $(tput bold)head -c 10000 < /dev/zero > 10k-null-bytes$(tput sgr0)\n
head	-c	10000	<	/dev/zero	>	10k-null-bytes
printf	Testing: $(tput bold)wc -c 10k-null-bytes$(tput sgr0) (Expecting "10000 10k-null-bytes", $(tput setaf 4 bold)15 points$(tput sgr0))\n
wc	-c	10k-null-bytes
